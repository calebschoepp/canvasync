...
ActiveRecord::Schema[7.1].define(version: 20_220_329_224_549) do
  ...
  create_table 'diffs', force: :cascade do |t|
    ...
    t.index %w[seq layer_id], name: 'index_diffs_on_seq_and_layer_id', unique: true
  end
  ...
  add_foreign_key 'exports', 'notebooks'
